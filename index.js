// hyphenator does not export his lib correct so we have to check if the lib
// is within our folder (development) or not  (production)
const hyphenator = require('./hyphenate.js').Hyphenator;
